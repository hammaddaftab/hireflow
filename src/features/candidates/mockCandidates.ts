...
export const MOCK_CANDIDATES: ParsedCandidateProfile[] = [
  // 1. Muhammad Ghulam Jillani — parsed from mock_resume_a.pdf
  {
    id: "cand_jillani",
  ...
  // 2. Abdullah Khan — parsed from mock_resume_b.pdf
  {
    id: "cand_abdullah",
    applied_job_id: "job-sample-1",
  ...
  // 3. Hamza Tariq — Senior Full Stack Engineer (Matches job-sample-1 criteria)
  {
    id: "cand_hamza",
    applied_job_id: "job-sample-1",
  ...
  // 4. Ayesha Malik — Frontend Engineer (Fails hard knockout: lacks Node.js & Event-Driven Architecture)
  {
    id: "cand_ayesha",
    applied_job_id: "job-sample-1",
      ...
      entries: [
        {
          ...
          raw_description:
            "Engineered responsive user interfaces using React, Next.js, and Tailwind CSS. Collaborated with UI/UX designers in Figma to build reusable component libraries and design systems.",
        },
        {
          entry_id: "work_2",
          employer: "Techlogix",
          ...
          raw_description:
            "Implemented frontend web modules in JavaScript and HTML/CSS for enterprise clients.",
        },
      ],
    },
    education: {
      ...
      skills: [
        {
          ...
          outcome_attached: null,
          concrete_noun_present: true,
          evidence_span: "Engineered responsive user interfaces using React, Next.js, and Tailwind CSS.",
          evidence_status: "confirmed",
        },
        {
          skill: "Next.js",
        ...
        },
        {
          ...
          outcome_attached: null,
          concrete_noun_present: true,
          evidence_span: "Collaborated with UI/UX designers in Figma to build reusable component libraries and design systems.",
          evidence_status: "confirmed",
        },
      ],
    },
  ...
  // 5. Bilal Ahmed — Golang Backend Developer (Unspecified/Unnormalizable location edge case)
  {
    id: "cand_bilal",
    applied_job_id: "job-sample-1",
      ...
      entries: [
        {
          ...
          raw_description:
            "Developed concurrent microservices in Go and gRPC, optimizing message pipelines for 8M events daily. Implemented Redis caching layers reducing database query frequency by 50%.",
        },
      ],
    },
    education: {
